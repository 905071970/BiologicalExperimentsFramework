...
public class ExperimentManager : MonoBehaviour
{
    ...
    #region 路径
    private  string TiShiPath = "Framework/ScriptObject/TiShi/";
    private  string CameraPosRotPath = "Framework/ScriptObject/CameraPosRot/";
    private  string StartPath = "Framework/ScriptObject/Start/";
    private string ChoicePath = "Framework/ScriptObject/Choice/";
    #endregion
